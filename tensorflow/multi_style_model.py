...
input_tensor = backend.concatenate([process_image("../StarryNight.jpg"), process_image("../tree.jpg"),process_image("../mooncake.jpeg"), x], axis=0)
...
content_image_features = layer_features[2, :, :, :]
...
image.save("content/sample_5.png")
